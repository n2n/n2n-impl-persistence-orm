...
class TimeColumnComparable extends ColumnComparableAdapter {
	...
	public function __construct(QueryItem $comparableQueryItem, private QueryState $queryState) {
		parent::__construct(CriteriaComparator::getOperators(false), 
				TypeConstraint::createSimple(Time::class, true), $comparableQueryItem);
	}
	
	private function buildDateTimeRawValue(?Time $value): ?string {
		if ($value === null) {
			return null;
		}
