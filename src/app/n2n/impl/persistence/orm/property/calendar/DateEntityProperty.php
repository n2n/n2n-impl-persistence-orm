...
class DateEntityProperty extends ColumnPropertyAdapter implements BasicEntityProperty {
	...
	public function valueToRep(mixed $value): string {
		ArgUtils::assertTrue($value instanceof Date);
